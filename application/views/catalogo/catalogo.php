  ...
  <div class="row">
    ...
    <?php else : ?>
      ...
      foreach ($producto as $fila) : ?>
        <div class="col">
          <div class="card">
            <img src="uploads/<?php echo $fila->img ?>" style="width: 10rem;" class="rounded" alt="...">
            <div class="card-body">
              ...
              <a href="#" class="btn btn-primary" id="addpedido<?php echo $a ?>" onclick="addProductCart(<?php echo $fila->id ?>)">Agregar</a>
            </div>
          </div>
        </div>
      <?php $a++;

                ...
                <div class="row">
                  ...
                  <div class="col s12 m3">
                    <div class="input-field">
                      ...
                      <input type="text" class="validate active" onkeypress="checkRut(this)" data-length="45" maxlength="45" id="idnumber<?php echo $i?>" value="<?php echo $filmaterial->idmaterial ?>">

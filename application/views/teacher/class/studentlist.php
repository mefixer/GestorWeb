...
<div class="card-panel">
  <div>
    ...
    <button class="btn "><i class="material-icons right">playlist_add_check</i> Add Student To Class</button>
  </div>
                          ...
                          <div class="input-field col s6">
                                <select id="idselectgender<?php echo $i?>">
                                  <?php $e = 0; foreach ($gender as $fil_gender):?>
                                    <option id="gender_option_edit<?php echo $i?>" value="<?php echo $fil_gender->idgender?>" <?php if($fila->gender_idgender === $fil_gender->idgender) echo "selected"?>> <?php echo $fil_gender->name?> </option>
                                  <?php $e++; endforeach; ?>
                                </select>
                                <label>Role</label>
                          </div>

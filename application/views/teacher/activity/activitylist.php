                                ...
                                <td>
                                    ...
                                    <div class="modal modal-fixed-footer" tabindex="-1" role="dialog" id="Modal_edit_activity<?php echo $i ?>">
                                        <div class="modal-content">
                                          ...
                                          <div class="input-field col s6" hidden="true">
                                            <input id="id_activity_class_edit<?php echo $i?>" type="text" value="<?php echo $filactivity->unity_class_idclass?>">
                                            <label for="id_activity_class_edit<?php echo $i?>" class="active">Id class</label>
                                          </div>
                                          <div class="input-field col s6" hidden="true">
                                            <input id="id_activity_material_type_edit<?php echo $i?>" type="text" value="<?php echo $filactivity->material_materialtype_idmaterialtype?>">
                                            <label for="id_activity_material_type_edit<?php echo $i?>" class="active">Id class</label>
                                          </div>
                                          <div class="input-field col s6">

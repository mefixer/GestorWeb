...
<div class="container" id="contenedor-activo">
  <div class="row">
    <div class="col-3"><h5>Menu</h5>
      <div class="list-group">
        <button type="button" class="list-group-item list-group-item-action list-group-item-success">Unit 1</button>
        <button type="button" class="list-group-item list-group-item-action">Unit 2</button>
        <button type="button" class="list-group-item list-group-item-action" disabled="">Unit 3</button>
        <button type="button" class="list-group-item list-group-item-action" disabled>Unit 3</button>
      </div></div>
      <div class="col-9">
        <h5>Activity</h5>

            ...
            <form id="form_img" method="post" enctype="multipar/upload" action="">
                <div class="card">
                    <div class="card-content">
                        <h4 style="font-weight: bolder;">INGRESO DE GALERIA</h4><br>
                        <div class="row">
                    ...
                    <div class="card-action">
                        ...
                        <div class="row">
                            <button type="submit" id="upload" class="btn green"><i class="material-icons">image</i> Guardar Galeria</button>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <div class="row">
                <div class="card">
                    <div class="card-content white-text">
                        <h4 style="font-weight: bolder;" class="black-text">GALERIAS ALMACENADAS</h4>
                        <div class="row">
                            <?php if ($galeria == 0) : ?>
                                <p class="black-text">No Hay Galerias almacenada!</p>
                            <?php else : ?>
                                <?php $a = 0;
                                foreach ($galeria as $fila) : ?>
                                    <div class="col s12">
                                        <div class="card medium">
                                            <div class="card-image"><img src="img/<?php echo $fila->imagen ?>" >

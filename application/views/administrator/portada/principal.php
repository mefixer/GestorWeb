            ...
            <form id="form_img" method="post" enctype="multipar/upload" action="">
                <div class="card">
                    <div class="card-content">
                        <h4 style="font-weight: bolder;">INGRESO DE PORTADA PRINCIAL</h4><br>
                        <div class="row">
                    ...
                    <div class="card-action">
                        ...
                        <div class="row">
                            <button type="submit" id="upload" class="btn green"><i class="material-icons">image</i> Guardar Portada Principal</button>
                        </div>
                    </div>
                </div>
            </form>
            ...
            <div class="row">
                <div class="card">
                    <div class="card-content white-text">
                        <h4 style="font-weight: bolder;" class="black-text">PORTADAS PRINCIPALES ALMACENADAS</h4>
                        <div class="row">
                            <?php if ($principal == 0) : ?>
                                    ...
                                    <div class="col s12">
                                        <div class="card medium">
                                            <div class="card-image">
                                                <center><img src="img/<?php echo $fila->imagen ?>" ></center>
